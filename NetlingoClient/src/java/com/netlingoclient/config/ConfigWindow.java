...
import com.netlingoclient.webservice.NetlingoClient;
...
//                    isWebServices = true; 
//                }
                    n1 = NetlingoClient.getInstance(Config.MY_IP, Config.MY_PORT, Config.MY_NAME);
                    n1.start();
                    Thread.sleep(2000);
                    //n1.search("Harry");
...
//                }
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 397, javax.swing.GroupLayout.PREFERRED_SIZE));
